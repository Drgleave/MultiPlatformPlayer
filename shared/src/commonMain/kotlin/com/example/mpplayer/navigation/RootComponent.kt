...
class RootComponent(
    ...
    private fun createChild(
        ...
        return when(config) {
            ...
            is Configuration.ScreenC -> Child.ScreenC(
                ScreenBComponent(
                    text = config.text,
                    componentContext = context,
                    onGoBack = {
            ...
            is Configuration.ScreenD -> Child.ScreenD(
                ScreenBComponent(
                    text = config.text,
                    componentContext = context,
                    onGoBack = {
    ...
    sealed class Child {
        ...
        data class ScreenC(val component: ScreenBComponent): Child()
        data class ScreenD(val component: ScreenBComponent): Child()
    }
    ...
    sealed class Configuration {
        ...
        @Serializable
        data class ScreenC(val text: String): Configuration()

        @Serializable
        data class ScreenD(val text: String): Configuration()
    }
}